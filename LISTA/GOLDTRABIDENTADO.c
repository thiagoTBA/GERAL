...
void excluirpaciente()//'FUNCAO EXCLUIRPACIENTE',REALIZAR A EXCLUSAO DE UM ELEMENTO DO CADASTRADO USANDO O NOME DE UM ELEMENTO COMO PARAMETRO
{
    ...
    else
    {
        ...
        for(i=0; i<posicao; i++)
        {
            ...
            {
                //Apagando as informaçoes do usuario no campos abaixo
                cadastro[i].nome[0] = '\0';
                ...
                if(posicao==2)//caso o numero de posiçoes preenchida no vetor seja igual a 2,ele executara este codigo
                {

                    for(i=0; i<posicao; i++)
                    {
                        //A funcionalidade 'strcpy' copia o cadastro da posiçao seguinte para a posicação apagada previamente
                ...
                if(posicao==3)//caso o numero de posiçoes preenchida no vetor seja igual a 3,ele executara este codigo
                {
                    for(i=0; i<posicao; i++)
                    {
                        //quase a mesma situação do anterior,so que ao invez de copiar o primeiro,ele mantera o primeiro e copiar o terceiro para a segunda posicao
