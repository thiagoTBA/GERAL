...
void excluirpaciente(){
	...
	printf("Digite o nome do Paciente a ser Excluido:  ");
	 ...
	 for(i=0;i<=3;i++){  
     if (strcmp(nome_pac,cadastro[i].nome)){
	   ...
	   /*
	   strcpy(cadastro[i].nome, cadastro[posicao].nome);
	   strcpy(cadastro[i].nomemedico, cadastro[posicao].nomemedico);
       strcpy(cadastro[i].datanasc, cadastro[posicao].datanasc);
       strcpy(cadastro[i].gensexo, cadastro[posicao].gensexo);
	   */
	 posicao--;
	 ;
	 }
